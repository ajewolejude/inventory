	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
	        ...
	        <?php if($_SESSION['role']=="admin"){
								echo '<button class="btn btn-default button1" data-toggle="modal" id="addProductModalBtn" data-target="#addProductModal"> <i class="glyphicon glyphicon-plus-sign"></i> Add Item </button>';
							} ?>
    	...
    	<form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
					    ...
					    <div class="kv-avatar center-block">					        
					        <input type="file" class="form-control" id="productImage" placeholder="Item Image Name" name="productImage" class="file-loading" style="width:auto;"/>
					    </div>
	        ...
	        <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="productName" placeholder="Item Name" name="productName" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	    
	        ...
	        <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" value="1" disabled class="form-control" id="quantity" placeholder="Quantity" name="quantity" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	        	 
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <select type="text" class="form-control" id="categoryName" placeholder="Category Name" name="categoryName" >
				      	<option value="">~~SELECT~~</option>
				      	<?php 
				      	$sql = "SELECT categories_id, categories_name, categories_active, categories_status FROM categories WHERE categories_status = 1 AND categories_active = 1 && type = '1'";
								$result = $connect->query($sql);
	             ...
	             <div class="form-group">
	        	<label for="computer_name" class="col-sm-3 control-label">Computer Name: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="computer_name" placeholder="Computer Name" name="computer_name" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	
	        ...
	        <div class="form-group">
	        	<label for="exp" class="col-sm-3 control-label">Expression: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
	      	...
	      	<div class="div-result">
				  ...
				  <div class="tab-content">
			        	...
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
							    <!-- the avatar markup -->
									<div id="kv-avatar-errors-1" class="center-block" style="display:none;"></div>							
							    <div class="kv-avatar center-block">					        
							        <input type="file" class="form-control" id="editProductImage" placeholder="Item Name" name="editProductImage" class="file-loading" style="width:auto;"/>
							    </div>
				    ...
				    <div role="tabpanel" class="tab-pane" id="productInfo">
				    	...
				    	<div class="form-group">
			        	<label for="editProductName" class="col-sm-3 control-label">Item Model Name: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
			        ...
			        <div class="form-group">
			        	...
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="text" value= "1"  class="form-control" id="editQuantity" placeholder="Quantity" name="editQuantity" autocomplete="off">
						    </div>
			        </div> <!-- /form-group-->	        	 
			        ...
			        <div class="form-group">
			        	<label for="editComputer" class="col-sm-3 control-label">Computer Name: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="text" class="form-control" id="editComputer" placeholder="Computer" name="editComputer" autocomplete="off">
						    </div>
			        </div> <!-- /form-group-->	     

			        <div class="form-group">
			        	<label for="editService" class="col-sm-3 control-label">Service Tag: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="text" class="form-control" id="editService" placeholder="Service" name="editService" autocomplete="off">
						    </div>
			        </div> <!-- /form-group-->	
			        ...
			        <div class="form-group">
	        	<label for="editPDate" class="col-sm-3 control-label">Purchase Date</label>
	        	<label class="col-sm-1 control-label"> : </label><div class="col-sm-8">
			      <input type="text" class="form-control" id="editPDate" name="editPDate" autocomplete="off" />
				    </div>
	        </div> <!-- /form-group-->  
			        ...
			        <div class="form-group">
			        	<label for="editExpName" class="col-sm-3 control-label">Exp Name: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <select type="text" class="form-control" id="editExpName" name="editExpName" >
						      	<option value="">~~SELECT~~</option>
				      	<option value="1">The Holy Trinity</option>
				      	<option value="2">The House of Freedom</option>
