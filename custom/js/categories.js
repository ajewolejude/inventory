...
$(document).ready(function() {
	...
	$('#addCategoriesModalBtn').unbind('click').bind('click', function() {
		...
		$("#submitCategoriesForm").unbind('submit').bind('submit', function() {
			...
			var categoriesType = $("#categoriesType").val();
			...
			if(categoriesType == "") {
				$("#categoriesType").after('<p class="text-danger">Brand Name field is required</p>');
				$('#categoriesType').closest('.form-group').addClass('has-error');
			} else {
				// remov error text field
				$("#categoriesType").find('.text-danger').remove();
				// success out for form 
				$("#categoriesType").closest('.form-group').addClass('has-success');	  	
			}

			if(categoriesName && categoriesStatus && categoriesType) {
				var form = $(this);
				// button loading
	...
	if(categoriesId) {
		...
		$.ajax({
			...
			success:function(response) {
				...
				$("#editCategoriesType").val(response.type);
				$("#editCategoriesValue").val(response.value);
				...
				$("#editCategoriesForm").unbind('submit').bind('submit', function() {
					...
					var categoriesType = $("#editCategoriesType").val();
					...
					if(categoriesType == "") {
						$("#editCategoriesType").after('<p class="text-danger">Brand Name field is required</p>');
						$('#editCategoriesType').closest('.form-group').addClass('has-error');
					} else {
						// remov error text field
						$("#editCategoriesType").find('.text-danger').remove();
						// success out for form 
						$("#editCategoriesType").closest('.form-group').addClass('has-success');	  	
					}
