			...
			<div class="panel-body">
				...
				<div class="div-action pull pull-right" style="padding-bottom:20px;">
					<?php if($_SESSION['role']=="admin"){
								echo '<button class="btn btn-default button1" data-toggle="modal" id="addCategoriesModalBtn" data-target="#addCategoriesModal"> <i class="glyphicon glyphicon-plus-sign"></i> Add Categories </button>';
							} ?>
    	...
    	<form class="form-horizontal" id="submitCategoriesForm" action="php_action/createCategories.php" method="POST">
	      ...
	      <div class="modal-body">
	        ...
	        <div class="form-group">
	        	<label for="categoriesName" class="col-sm-4 control-label">Name: </label>
...
<!-- /form-group-->	         	        
	        <div class="form-group">
	        	<label for="categoriesType" class="col-sm-4 control-label">Type: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-7">
				      <select class="form-control" id="categoriesType" name="categoriesType">
 ...
 <div class="form-group" id = "catVal">
	        	<label for="categoriesValue" class="col-sm-4 control-label">Value: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-7">
				      <input type="text" class="form-control" id="categoriesValue" placeholder="Categories Value" name="categoriesValue" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	   			
	        <div class="form-group">
...
<div class="modal fade" id="editCategoriesModal" tabindex="-1" role="dialog">
    	...
    	<form class="form-horizontal" id="editCategoriesForm" action="php_action/editCategories.php" method="POST">
	      ...
	      <div class="modal-body">
		      ...
		      <div class="edit-categories-result">
		      	<div class="form-group">
		        	<label for="editCategoriesName" class="col-sm-4 control-label">Name: </label>
		        	<label class="col-sm-1 control-label">: </label>
					    <div class="col-sm-7">
 ...
 <div class="form-group">
		        	<label for="editCategoriesType" class="col-sm-4 control-label">Type: </label>
		        	<label class="col-sm-1 control-label">: </label>
					    <div class="col-sm-7">
					      <select class="form-control" id="editCategoriesType" name="editCategoriesType">
					      	<option value="">~~SELECT~~</option>
					      	<option value="1">Asset</option>
					      	<option value="2">Consumable</option>
					      </select>
				...
				<div class="form-group" >
		        	<label for="editCategoriesValue" class="col-sm-4 control-label">Value: </label>
		        	<label class="col-sm-1 control-label">: </label>
					    <div class="col-sm-7">
					      <input type="text" class="form-control" id="editCategoriesValue" placeholder="Categories Value" name="editCategoriesValue" autocomplete="off">
					    </div>
		        </div> <!-- /form-group-->	 
